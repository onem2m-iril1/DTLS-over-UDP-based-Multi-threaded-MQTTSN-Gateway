# DTLS-over-UDP-based-Multi-threaded-MQTTSN-Gateway
DTLS support on MQTT-SN in compliance with oneM2M

/*
 *	Author:			  TOMOAKI YAMAGUCHI
 *	Contributor:	BILAL IMRAN
 *  Team:         oneM2M Security Framework Developer for constrained IoT devices @ IRIL KICS UET, Lahore
 ...
 *
 *		(2)	Certificate based DTLS over UDP Connection Setting:
 *				->	BrokerSecurePortNo set to 8883
 *				->	BrokerName set to IP address of the Mosquitto MQTT Broker
 *				->	DTLSServerName set to the IP address of the MQTTSN Gateway
 *				->	DTLSPortNo set to the desired port number for MQTTSN Gateway DTLS server (6667 by default)
 ...
 *		<NOTE: 09> Please set other settings accordingly to make this setting work on MQTTSN Gateway
 *
 *		(3)	Pre-shared Key based TLS over TCP Connection Settings:
 *				->	BrokerSecurePortNo set to 8883
 *				->	BrokerName set to IP address of the Mosquitto MQTT Broker
 ...
 *		<NOTE: 09> Please set other settings accordingly to make this setting work on MQTTSN Gateway
 *
 *		(4) Certificate based TLS over TCP Connection Settings:
 *				->	BrokerSecurePortNo set to 8883
 *				->	BrokerName set to IP address of the Mosquitto MQTT Broker
