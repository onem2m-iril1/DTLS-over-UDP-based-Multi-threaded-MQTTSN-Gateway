/*
 * 	File Name:	Gateway/MN_Server/MAF_Client
	File Purpose:	This file contains detailed implementation of a Server
	* 		application which is responsible to authenticate two 
	* 		end to end devices using GBA Frmaework
...
// Static Configuration 'gateway.config1'
